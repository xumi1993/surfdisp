...
! openmp wrapper
!$omp threadprivate(mmax,zd,zb,zrho,za,xmu,iwat)
!$omp threadprivate(uu,tt,dcdb,dcdh,dcdr,uu0,vtp,dtp,rtp)
!$omp threadprivate(exl,cosq,sinq,yl,zl,mu)
